...
export default async function HomePage({ params }: Props) {
  ...
  const categories = [
    { emoji: "🌹", title: t.cutFlowersTitle,    desc: t.cutFlowersDesc,    href: lp("/products/cut-flowers") },
    { emoji: "🪴", title: t.pottedPlantsTitle,  desc: t.pottedPlantsDesc,  href: lp("/products/potted-plants") },
    { emoji: "🧅", title: t.bulbsTitle,          desc: t.bulbsDesc,          href: lp("/products/bulbs") },
    { emoji: "📦", title: t.accessoriesTitle,    desc: t.accessoriesDesc,    href: lp("/products/accessories") },
  ];

  const audiences = [
    { icon: "🌸", title: t.floristsTitle, desc: t.floristsDesc, cta: t.floristsCta, href: lp("/for/florists") },
    { icon: "🎊", title: t.eventsTitle,   desc: t.eventsDesc,   cta: t.eventsCta,   href: lp("/for/events") },
    { icon: "🏨", title: t.hotelsTitle,   desc: t.hotelsDesc,   cta: t.hotelsCta,   href: lp("/for/hotels") },
  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{t.catalogTitle}</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">{t.catalogSub}</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{t.audienceTitle}</h2>
      ...
      <section className="py-20 bg-gray-50 border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{t.whyTitle}</h2>
          </div>
      ...
      <section className="py-20 bg-green-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">{t.ctaBannerTitle}</h2>
